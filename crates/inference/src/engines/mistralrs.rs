...
use mistralrs::{
    ...
    NormalSpecificConfig, PagedAttentionConfig, RequestBuilder,
    SchedulerConfig, TextMessageRole, TokenSource, Tool, ToolChoice, ToolType,
    Topology, best_device, initialize_logging, paged_attn_supported,
};
...
impl MistralRsEngine {
    pub async fn new(model_id: impl ToString) -> Result<Self> {
        let builder = GgufModelBuilder::new(model_id)
            .with_force_cpu();
        Ok(MistralRsEngine {
